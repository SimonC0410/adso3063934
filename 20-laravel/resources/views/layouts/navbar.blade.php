<div class="navbar bg-[#020202aa] shadow-sm fixed top-0 text-white">
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="-1" class="menu menu-sm dropdown-content bg-[#020202aa] rounded-box z-1 mt-3 w-52 p-2 shadow">
                <li>
